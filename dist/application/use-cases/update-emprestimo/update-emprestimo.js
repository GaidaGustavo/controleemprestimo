...
exports.UpdateEmprestimoUseCase = void 0;
const emprestimo_1 = require("../../../domain/entity/emprestimo");
class UpdateEmprestimoUseCase {
    ...
    execute(input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newEmprestimo = new emprestimo_1.Emprestimo(item, pessoa, usuario, input.id, input.dataDevolução);
            yield this.emprestimoRepository.update(newEmprestimo);
            return {};
        });
    }
}
exports.UpdateEmprestimoUseCase = UpdateEmprestimoUseCase;
